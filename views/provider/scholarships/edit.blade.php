                ...
                <form action="{{ route('provider.scholarships.update', $scholarship->id_beasiswa) }}" method="POST" class="space-y-8">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="date" name="deadline" value="{{ $scholarship->deadline }}" class="w-full bg-gray-50 border-2 border-gray-200 rounded-2xl pl-14 pr-5 py-5 text-gray-900 font-bold focus:outline-none focus:border-cyan-500 focus:ring-4 focus:ring-cyan-100 transition">
                        </div>
                    </div>

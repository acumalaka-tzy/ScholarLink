...
<body class="bg-[#f4f7f9] text-gray-900 antialiased selection:bg-blue-600 selection:text-white">
    ...
    <div class="min-h-screen grid lg:grid-cols-2">
        ...
        <div class="hidden lg:flex flex-col justify-between p-8 xl:p-12 relative overflow-hidden bg-gradient-to-br from-cyan-50 via-[#d1e9f6] to-cyan-50">
            ...
            <div class="max-w-xl relative z-10">
                ...
                <h2 class="text-4xl xl:text-5xl font-black leading-tight mb-6 text-gray-900">
                    Daftar dan mulai <br>
                ...
                <div class="grid grid-cols-3 gap-4">
                    <div class="bg-white rounded-3xl p-5 border border-gray-100 shadow-sm text-center">
                        <p class="text-2xl xl:text-3xl font-black text-blue-600">1K+</p>
                        <p class="text-gray-500 text-xs mt-1 font-bold">Beasiswa</p>
                    </div>

                    <div class="bg-white rounded-3xl p-5 border border-gray-100 shadow-sm text-center">
                        <p class="text-2xl xl:text-3xl font-black text-orange-500">500+</p>
                        <p class="text-gray-500 text-xs mt-1 font-bold">Penerima</p>
                    </div>

                    <div class="bg-white rounded-3xl p-5 border border-gray-100 shadow-sm text-center">
                        <p class="text-2xl xl:text-3xl font-black text-green-600">Gratis</p>
        ...
        <div class="flex items-center justify-center p-4 sm:p-6 md:p-8 lg:p-12 bg-[#f4f7f9] min-h-screen">
            <div class="w-full max-w-md bg-white p-5 sm:p-8 md:p-10 rounded-2xl sm:rounded-[2rem] shadow-sm border border-gray-100">
                
                <div class="mb-6 sm:mb-8">
                    <div class="flex lg:hidden items-center gap-2 mb-4">
                        <div class="w-7 h-7 bg-gradient-to-br from-blue-600 to-cyan-400 rounded-md flex items-center justify-center text-white font-black text-sm shadow-sm">
                            S
                        </div>
                        <span class="text-lg font-black tracking-tight text-gray-900">ScholarLink</span>
                    </div>
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-4 sm:space-y-5">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" id="name" name="name" value="{{ old('name') }}" required autofocus class="w-full pl-10 sm:pl-11 pr-4 py-2.5 sm:py-3 bg-gray-50 border-2 border-gray-100 rounded-xl font-semibold text-gray-900 placeholder-gray-400 focus:outline-none focus:border-blue-500 focus:bg-white transition text-base">
                        </div>
                        @error('name')
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="email" id="email" name="email" value="{{ old('email') }}" required class="w-full pl-10 sm:pl-11 pr-4 py-2.5 sm:py-3 bg-gray-50 border-2 border-gray-100 rounded-xl font-semibold text-gray-900 placeholder-gray-400 focus:outline-none focus:border-blue-500 focus:bg-white transition text-base">
                        </div>
                        @error('email')
                            <p class="text-red-500 text-xs font-bold mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <select id="role" name="role" required class="w-full pl-10 sm:pl-11 pr-10 py-2.5 sm:py-3 bg-gray-50 border-2 border-gray-100 rounded-xl font-semibold text-gray-900 focus:outline-none focus:border-blue-500 focus:bg-white transition appearance-none text-base">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="password" id="password" name="password" required class="w-full pl-10 sm:pl-11 pr-4 py-2.5 sm:py-3 bg-gray-50 border-2 border-gray-100 rounded-xl font-semibold text-gray-900 placeholder-gray-400 focus:outline-none focus:border-blue-500 focus:bg-white transition text-base">
                        </div>
                        @error('password')
                            <p class="text-red-500 text-xs font-bold mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="password" id="password_confirmation" name="password_confirmation" required class="w-full pl-10 sm:pl-11 pr-4 py-2.5 sm:py-3 bg-gray-50 border-2 border-gray-100 rounded-xl font-semibold text-gray-900 placeholder-gray-400 focus:outline-none focus:border-blue-500 focus:bg-white transition text-base">
                        </div>
                    </div>

                    <button type="submit" class="w-full bg-gradient-to-r from-blue-600 to-cyan-600 text-white py-3 sm:py-4 rounded-xl font-black hover:from-blue-700 hover:to-cyan-700 transition shadow-lg shadow-blue-600/20 text-center block mt-6 sm:mt-8 text-sm sm:text-base active:scale-[0.99]">
                        Daftar Akun Gratis
                    </button>
                </form>
                
                <p class="text-gray-400 text-center text-xs mt-8 font-bold lg:hidden">
                    &copy; 2026 ScholarLink. Semua hak dilindungi secara berwarna.
                </p>
            </div>
        </div>

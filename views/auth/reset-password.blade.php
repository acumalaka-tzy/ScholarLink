        ...
        <div class="hidden lg:flex flex-col justify-between p-12 relative overflow-hidden">
            ...
            <div class="max-w-xl">
                ...
                <h2 class="text-5xl font-black leading-tight text-gray-900 mb-6">
                    Amankan kembali <span class="text-orange-600">akses akun</span> Anda.
                </h2>
                <p class="text-gray-600 text-lg leading-relaxed font-bold mb-10">
                    Silakan buat kata sandi baru yang kuat untuk melindungi aplikasi beasiswa, dokumen, dokumen penting, dan data pribadi Anda.
                </p>
            ...
            <div class="w-full max-w-md">
                ...
                <div class="bg-white rounded-[2rem] shadow-xl border border-gray-100 p-8 md:p-10">
                    <div class="mb-8">
                        ...
                        <h2 class="text-4xl font-black text-gray-900 mb-3">Reset Password</h2>
                        <p class="text-gray-500 font-bold leading-relaxed">
                            Silakan masukkan email Anda beserta kata sandi baru untuk memulihkan akses penuh.
                        </p>
                    </div>
                    ...
                    @if (session('status'))
                        <div class="mb-6 bg-green-50 border border-green-200 rounded-2xl p-5">
                            <div class="flex items-center gap-3">
                                <div class="text-green-500 text-xl"><i class="bi bi-check-circle-fill"></i></div>
                                <div class="text-sm text-green-700 font-bold">{{ session('status') }}</div>
                            </div>
                        </div>
                    @endif
                    ...
                    @if ($errors->any())
                        <div class="mb-6 bg-red-50 border border-red-200 rounded-2xl p-5">
                            <div class="flex items-start gap-3">
                                <div class="text-red-500 text-xl"><i class="bi bi-exclamation-circle-fill"></i></div>
                                <div>
                    ...
                    <form method="POST" action="{{ route('password.update') }}" class="space-y-5">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input id="email" type="email" name="email" value="{{ old('email', $request->email) }}" required autofocus autocomplete="username" class="w-full bg-gray-50 border-2 border-gray-200 rounded-2xl pl-14 pr-5 py-4 font-bold text-gray-900 placeholder:text-gray-400 focus:outline-none focus:border-cyan-500 focus:ring-4 focus:ring-cyan-100 transition">
                            </div>
                        </div>

                        <div>
                            <label for="password" class="block text-sm font-black text-gray-700 mb-2">Password Baru</label>
                            <div class="relative">
                                <div class="absolute left-5 top-1/2 -translate-y-1/2 text-gray-400">
                                    <i class="bi bi-lock-fill"></i>
                                </div>
                                <input id="password" type="password" name="password" required autocomplete="new-password" placeholder="Minimal 8 karakter baru" class="w-full bg-gray-50 border-2 border-gray-200 rounded-2xl pl-14 pr-5 py-4 font-bold text-gray-900 placeholder:text-gray-400 focus:outline-none focus:border-cyan-500 focus:ring-4 focus:ring-cyan-100 transition">
                            </div>
                        </div>

                        <div>
                            <label for="password_confirmation" class="block text-sm font-black text-gray-700 mb-2">Konfirmasi Password Baru</label>
                            <div class="relative">
                                <div class="absolute left-5 top-1/2 -translate-y-1/2 text-gray-400">
                                    <i class="bi bi-shield-check-fill"></i>
                                </div>
                                <input id="password_confirmation" type="password" name="password_confirmation" required autocomplete="new-password" placeholder="Ulangi password baru" class="w-full bg-gray-50 border-2 border-gray-200 rounded-2xl pl-14 pr-5 py-4 font-bold text-gray-900 placeholder:text-gray-400 focus:outline-none focus:border-cyan-500 focus:ring-4 focus:ring-cyan-100 transition">
                            </div>
                        </div>
                    ...
                    <div class="mt-8 text-center">
                        <p class="text-gray-500 font-bold">
                            ...
                            <a href="{{ route('login') }}" class="text-orange-500 hover:text-orange-600 font-black transition">Masuk sekarang</a>
                        </p>
                    </div>
                </div>

                <div class="mt-6 text-center">
                    <a href="{{ route('login') }}" class="inline-flex items-center gap-2 text-gray-500 hover:text-gray-700 text-sm font-black transition">

        ...
        <div class="flex items-center justify-center px-4 py-6 md:px-6 md:py-8 lg:p-0">
            <div class="w-full max-w-md">
                ...
                <div class="bg-white rounded-2xl lg:rounded-[2rem] shadow-xl border border-gray-100 p-5 md:p-8 lg:p-10">
                    ...
                    <form method="POST" action="<?php echo e(route('login')); ?>" class="space-y-4 md:space-y-5">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="flex items-center justify-between gap-4 pt-1">
                            ...
                            <?php if(Route::has('password.request')): ?>
                                <a href="<?php echo e(route('password.request')); ?>" class="text-xs md:text-sm text-cyan-600 hover:text-cyan-700 font-black transition">
                                    Lupa password?
                                </a>
                            <?php endif; ?>
                        </div>
                    ...
                    <div class="mt-6 md:mt-8 text-center">
                        <p class="text-gray-500 font-bold text-xs md:text-base">
                            Belum punya akun?
                            <a href="<?php echo e(route('register')); ?>" class="text-orange-500 hover:text-orange-600 font-black transition">
                                Daftar sekarang
                            </a>
                        </p>
                    </div>
                ...
                <div class="mt-4 md:mt-6 text-center">
                    <a href="<?php echo e(route('home')); ?>" class="inline-flex items-center gap-2 text-gray-500 hover:text-gray-700 text-xs md:text-sm font-black transition">
...
<?php /**PATH C:\wl\ScholarLink-main\ScholarLink-main\resources\views/auth/login.blade.php ENDPATH**/ ?>
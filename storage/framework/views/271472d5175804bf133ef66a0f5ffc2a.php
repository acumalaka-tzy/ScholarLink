<section class="space-y-6 sm:space-y-8">
    ...
    <div class="relative overflow-hidden bg-white border border-gray-100 rounded-lg sm:rounded-[2.5rem] shadow-[0_25px_80px_rgba(15,23,42,0.08)]">
        ...
        <div class="relative p-5 sm:p-8 md:p-10">
            ...
            <form method="post" action="<?php echo e(route('profile.update')); ?>" class="space-y-6 sm:space-y-8">
                <?php echo csrf_field(); ?>
...
<?php endif; ?>
                ...
                <div class="flex flex-col sm:flex-row gap-3 sm:gap-5 pt-4">
                    <button type="submit" class="group relative overflow-hidden inline-flex items-center justify-center gap-2 sm:gap-3 bg-gradient-to-r from-blue-600 via-cyan-500 to-orange-400 hover:scale-[1.02] transition duration-300 px-6 sm:px-8 py-3 sm:py-5 rounded-lg sm:rounded-2xl font-black text-white shadow-[0_15px_50px_rgba(59,130,246,0.3)] text-xs sm:text-base">
...
<?php /**PATH C:\wl\ScholarLink-main\ScholarLink-main\resources\views/profile/partials/update-profile-information-form.blade.php ENDPATH**/ ?>
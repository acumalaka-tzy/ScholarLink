<section class="space-y-6 sm:space-y-8">
    ...
    <div class="relative overflow-hidden bg-white border border-gray-100 rounded-lg sm:rounded-[2.5rem] shadow-[0_25px_80px_rgba(15,23,42,0.08)]">
        ...
        <div class="relative p-5 sm:p-8 md:p-10">
            ...
            <form method="post" action="<?php echo e(route('password.update')); ?>" class="space-y-5 sm:space-y-8">
                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\wl\ScholarLink-main\ScholarLink-main\resources\views/profile/partials/update-password-form.blade.php ENDPATH**/ ?>
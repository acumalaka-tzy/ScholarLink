        ...
        <div id="success-alert" class="mb-6 sm:mb-8 bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-lg sm:rounded-2xl p-4 sm:p-6 shadow-lg animate-bounce-in">
            <div class="flex flex-col sm:flex-row sm:items-start gap-4">
                ...
                <div class="flex-1">
                    ...
                    <p class="text-green-600 font-bold text-xs sm:text-base mb-3"><?php echo e(session('success')); ?></p>
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 sm:gap-5 mb-8 sm:mb-10">
        ...
        <div class="bg-white border border-gray-100 rounded-lg sm:rounded-[2rem] px-4 sm:px-7 py-4 sm:py-5 shadow-xl">
            ...
            <div class="flex items-center gap-3 sm:gap-4">
                ...
                <h2 class="text-2xl sm:text-4xl font-black text-gray-900"><?php echo e($applications->count()); ?></h2>
            </div>
        </div>
    </div>
                ...
                <div class="group bg-white border border-gray-100 rounded-[2rem] p-8 shadow-2xl hover:scale-[1.02] transition duration-300 overflow-hidden relative">
                    ...
                    <div class="flex items-start justify-between gap-4 mb-7">
                        <div class="flex items-start gap-4">
                            ...
                            <div>
                                <h2 class="text-2xl font-black text-gray-900 mb-2"><?php echo e($application->scholarship->nama_beasiswa); ?></h2>
                                <p class="text-gray-500 font-bold line-clamp-2"><?php echo e($application->scholarship->deskripsi); ?></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-5 mb-8">
                        <div class="flex items-center justify-between gap-4">
                            ...
                            <span class="font-black text-gray-900 text-right"><?php echo e($application->user->name); ?></span>
                        </div>
                        ...
                        <div class="flex items-center justify-between gap-4">
                            ...
                            <span class="font-black text-gray-900 text-right"><?php echo e($application->scholarship->provider->nama_instansi ?? '-'); ?></span>
                        </div>
                        ...
                        <div class="flex items-center justify-between gap-4">
                            ...
                            <span class="font-black text-gray-900 text-right">
                                <?php echo e(\Carbon\Carbon::parse($application->tanggal_apply)->format('d M Y')); ?>
                    ...
                    <div class="flex flex-wrap gap-4">
                        <a href="<?php echo e(route('applications.show', $application->id_application)); ?>" class="flex-1 min-w-[150px] text-center bg-gradient-to-r from-blue-600 to-cyan-500 hover:from-blue-700 hover:to-cyan-600 transition text-white py-4 rounded-2xl font-black shadow-lg shadow-blue-500/20">
                            <i class="bi bi-eye-fill mr-2"></i> Detail
                        </a>

                        <?php if($application->status == 'pending'): ?>
                            <form action="<?php echo e(route('applications.destroy', $application->id_application)); ?>" method="POST" class="flex-1 min-w-[150px]">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wl\ScholarLink-main\ScholarLink-main\resources\views/applications/index.blade.php ENDPATH**/ ?>
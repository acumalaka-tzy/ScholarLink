...
<body class="bg-[#f4f7f9] text-gray-900 antialiased selection:bg-blue-600 selection:text-white">
    ...
    <nav class="w-full bg-white px-6 py-4 flex items-center justify-between shadow-sm sticky top-0 z-50">
        <div class="max-w-7xl mx-auto w-full flex justify-between items-center">
            ...
            <div class="flex gap-4 items-center">
                <?php if(auth()->guard()->check()): ?>
                    <div class="hidden lg:flex gap-4 mr-4 border-r border-gray-200 pr-4">
                        <?php if(auth()->user()->role === 'mahasiswa'): ?>
                            <a href="<?php echo e(route('applications.index')); ?>" class="text-sm font-bold text-gray-600 hover:text-cyan-600">Application</a>
                            <a href="<?php echo e(route('documents.index')); ?>" class="text-sm font-bold text-gray-600 hover:text-cyan-600">Document</a>
                        <?php elseif(auth()->user()->role === 'provider'): ?>
                            <a href="<?php echo e(route('provider.scholarships.index')); ?>" class="text-sm font-bold text-gray-600 hover:text-cyan-600">Beasiswa Saya</a>
                        <?php elseif(auth()->user()->role === 'admin'): ?>
                            <a href="<?php echo e(route('admin.users.index')); ?>" class="text-sm font-bold text-gray-600 hover:text-cyan-600">Users</a>
                        <?php endif; ?>
                    </div>

                    <a href="<?php echo e($dashboardRoute); ?>" class="text-sm font-black text-gray-700 hover:text-cyan-600 transition">Dashboard</a>
                ...
                <?php else: ?>
                    <a href="<?php echo e(route('login')); ?>" class="text-sm font-black text-gray-700 hover:text-cyan-600 hidden sm:block transition">Masuk</a>
                    <a href="<?php echo e(route('register')); ?>" class="bg-gradient-to-r from-blue-600 to-cyan-600 text-white px-6 py-2 rounded-full text-sm font-bold hover:from-blue-700 hover:to-cyan-700 transition shadow-md shadow-blue-600/20">
                        Daftar Gratis
                    </a>
                <?php endif; ?>
            </div>
            ...
            <div class="max-w-xl">
                ...
                <div class="flex gap-4 flex-wrap">
                    <?php if(auth()->guard()->check()): ?>
                        ...
                        <a href="<?php echo e($dashboardRoute); ?>" class="bg-white border-2 border-gray-200 text-gray-800 px-8 py-4 rounded-xl font-black hover:border-gray-300 transition">
                            Dashboard Saya
                        </a>
                    <?php else: ?>
                        <a href="<?php echo e(route('register')); ?>" class="bg-gradient-to-r from-blue-600 to-cyan-600 text-white px-8 py-4 rounded-xl font-black hover:from-blue-700 hover:to-cyan-700 transition shadow-lg shadow-blue-600/30">
                            Mulai Sekarang
                        </a>
                        <a href="<?php echo e(route('login')); ?>" class="bg-white border-2 border-gray-200 text-gray-800 px-8 py-4 rounded-xl font-black hover:border-gray-300 transition">
                            Masuk Akun
                        </a>
                    <?php endif; ?>
                </div>
            ...
            <section class="py-16 bg-white relative">
                <div class="max-w-7xl mx-auto px-6">
                    ...
                    <div class="grid md:grid-cols-3 gap-8">
                        <a href="<?php echo e(route('applications.index')); ?>" class="bg-gradient-to-br from-blue-100 to-cyan-100 rounded-3xl p-8 border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition duration-300 flex flex-col">
                        ...
                        <a href="<?php echo e(route('documents.index')); ?>" class="bg-gradient-to-br from-orange-100 to-magenta-100 rounded-3xl p-8 border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition duration-300 flex flex-col">
                        ...
                        <a href="<?php echo e(route('favorites.index')); ?>" class="bg-gradient-to-br from-yellow-100 to-pink-100 rounded-3xl p-8 border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition duration-300 flex flex-col">
    ...
    <section id="scholarships" class="py-20 bg-[#fff8f8]">
        <div class="max-w-7xl mx-auto px-6">
            <div class="flex justify-between items-end mb-12">
                ...
                <a href="<?php echo e(route('scholarships.index')); ?>" class="hidden md:inline-block border-2 border-orange-200 text-orange-700 px-6 py-2 rounded-full font-black hover:border-orange-600 hover:text-orange-600 transition">
                    Lihat Semua &rarr;
                </a>
            </div>

            <?php $scholarships = $scholarships ?? collect(); ?>

            <?php if($scholarships->count() > 0): ?>
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-10">
                    <?php $__currentLoopData = $scholarships->take(6); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $scholarship): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                        ...
                        <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-xl transition duration-300 flex flex-col h-full">
                            ...
                            <div class="p-6 pb-4 border-b border-gray-50 relative">
                                <?php if($scholarship->status === 'aktif'): ?>
                                ...
                                <p class="text-orange-600 text-xs font-black uppercase tracking-wider mb-2">
                                    <?php echo e($scholarship->category->nama_kategori ?? 'Umum'); ?>
                                ...
                                <p class="text-gray-500 text-sm font-bold">
                                    by <?php echo e($scholarship->provider->nama_instansi ?? 'Provider'); ?>
                            ...
                            <div class="p-6 flex-grow">
                                <p class="text-gray-600 text-sm mb-6 line-clamp-3 leading-relaxed font-semibold">
                                    <?php echo e(\Illuminate\Support\Str::limit($scholarship->deskripsi, 120)); ?>
                                ...
                                <div class="space-y-3 mb-6">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm font-black text-gray-900"><?php echo e($scholarship->tipe ?? '-'); ?></p>
                                        </div>
                                    </div>
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-sm font-black text-gray-900 line-clamp-1"><?php echo e($scholarship->benefit ?? '-'); ?></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="p-6 pt-0 mt-auto">
                                <div class="flex items-center justify-between mb-4">
                                    <div class="flex items-center gap-2">
                                        ...
                                        <span class="text-sm font-black <?php echo e($deadline && $deadline->isPast() ? 'text-red-500' : 'text-gray-700'); ?>">
                                            <?php echo e($deadline ? $deadline->format('d M Y') : 'Belum tersedia'); ?>

                                        </span>
                                    </div>
                                </div>
                                <a href="<?php echo e(route('scholarships.show', $scholarship->id_beasiswa)); ?>" class="block text-center w-full bg-gradient-to-r from-blue-600 to-cyan-500 hover:from-blue-700 hover:to-cyan-600 text-white py-3 rounded-xl font-black transition">
                                    <?php if(auth()->guard()->check()): ?> Lihat Detail & Daftar <?php else: ?> Lihat Detail <?php endif; ?>
                                </a>
                            </div>
                        </div>
                ...
                <div class="text-center md:hidden">
                    <a href="<?php echo e(route('scholarships.index')); ?>" class="inline-block border-2 border-orange-200 text-orange-700 px-8 py-3 rounded-full font-black hover:border-orange-600 hover:text-orange-600 transition">
    ...
    <section class="py-24 bg-gradient-to-r from-blue-600 via-magenta-600 to-orange-600 text-white text-center px-6">
        <div class="max-w-3xl mx-auto">
            ...
            <?php if(auth()->guard()->check()): ?>
                <a href="<?php echo e($dashboardRoute); ?>" class="bg-white text-blue-700 px-10 py-4 rounded-xl font-black inline-block text-lg shadow-lg hover:scale-105 transition duration-300">
                    Jelajahi Beasiswa Sekarang
                </a>
            <?php else: ?>
                <a href="<?php echo e(route('register')); ?>" class="bg-white text-blue-700 px-10 py-4 rounded-xl font-black inline-block text-lg shadow-lg hover:scale-105 transition duration-300">
...
<?php /**PATH C:\wl\ScholarLink-main\ScholarLink-main\resources\views/home.blade.php ENDPATH**/ ?>
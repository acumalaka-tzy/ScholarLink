                    ...
                    <form method="POST" action="{{ route('password.confirm') }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="flex items-center bg-gray-50 border-2 border-gray-200 rounded-2xl focus-within:border-cyan-500 focus-within:ring-4 focus-within:ring-cyan-100 transition duration-300">
                                ...
                                <input id="password" type="password" name="password" required autocomplete="current-password" autofocus placeholder="Masukkan password Anda" class="w-full bg-transparent border-0 focus:ring-0 py-4 px-4 font-bold text-gray-900 placeholder:text-gray-400 text-base">
                            </div>
                        </div>

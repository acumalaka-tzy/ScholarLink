        ...
        <div class="hidden lg:flex flex-col justify-between p-6 lg:p-8 xl:p-12 relative overflow-hidden bg-gradient-to-br from-cyan-50 via-[#d1e9f6] to-cyan-50">
            ...
            <div class="max-w-2xl mx-auto relative z-10">
                ...
                <h2 class="text-3xl lg:text-5xl font-black leading-tight mb-4 lg:mb-6 text-gray-900">
                    ...
                    <span class="text-orange-600">beasiswa impian</span> Anda.
                </h2>
            ...
            <div class="w-full flex flex-col items-center">
                ...
                <div class="w-full max-w-md bg-white p-5 md:p-8 lg:p-10 rounded-2xl md:rounded-[2.5rem] shadow-sm border border-gray-100">
                    ...
                    <div class="mb-6 md:mb-8">
                        <h3 class="text-2xl md:text-3xl font-black text-gray-900 mb-2">Masuk Akun</h3>
                    ...
                    <form method="POST" action="{{ route('login') }}" class="login-form space-y-4 md:space-y-5">
                        @csrf
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input id="password" type="password" name="password" required autocomplete="current-password" class="w-full pl-10 md:pl-11 pr-12 py-2.5 md:py-3 bg-gray-50 border-2 border-gray-100 rounded-lg md:rounded-xl font-semibold text-gray-900 focus:outline-none focus:border-blue-500 focus:bg-white transition text-sm md:text-base">
                                <button type="button" onclick="togglePassword()" class="absolute inset-y-0 right-0 flex items-center pr-4 text-gray-400 hover:text-blue-600">

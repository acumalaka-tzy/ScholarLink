...
<body class="bg-gradient-to-br from-slate-950 via-blue-950 to-slate-900 min-h-screen text-white">
    ...
    <!-- Navbar -->
    <nav class="w-full border-b border-white/10 backdrop-blur-lg bg-white/5 sticky top-0 z-50">
        <div class="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
            ...
            <div class="hidden md:flex gap-8 text-gray-300 font-medium">
                ...
                <a href="#" class="hover:text-blue-400 transition">Beasiswa</a>
                <a href="#" class="hover:text-blue-400 transition">Kategori</a>
        ...
        <div class="grid lg:grid-cols-2 gap-10 items-center">
            ...
            <div>
                ...
                <p class="text-gray-300 text-lg leading-relaxed mb-8">
                    ScholarLink membantu mahasiswa menemukan informasi
                    beasiswa terbaru dengan tampilan modern, cepat,
                    dan mudah digunakan.
                </p>
            ...
            <div class="relative">
                ...
                <div class="bg-white/10 border border-white/10 backdrop-blur-xl rounded-3xl p-8 shadow-2xl relative">
                    ...
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <div class="bg-green-500/20 text-green-300 px-4 py-2 rounded-xl text-sm">
                            Online
                        </div>
                    </div>
        ...
        <div class="flex items-center justify-between mb-10">
            ...
            <div>
                ...
                <p class="text-gray-400">
                    Temukan peluang terbaik untuk masa depanmu
                </p>
            </div>
            ...
            <div class="group relative overflow-hidden bg-white/10 backdrop-blur-xl border border-white/10 rounded-3xl p-7 hover:scale-105 transition duration-500 shadow-2xl">
                ...
                <div class="relative">
                    ...
                    <div class="flex items-start justify-between mb-5">
                        ...
                        <div>
                            <h3 class="text-2xl font-bold mb-2 group-hover:text-blue-400 transition">
                                {{ $item->nama_beasiswa }}
                            </h3>

                            <span class="bg-green-500/20 text-green-300 px-4 py-1 rounded-full text-sm">
                                {{ $item->status }}
                            </span>
                        </div>
                    ...
                    <button class="w-full bg-gradient-to-r from-blue-500 to-cyan-400 hover:from-blue-600 hover:to-cyan-500 py-4 rounded-2xl font-bold text-lg transition shadow-xl shadow-blue-500/30">
                        Lihat Detail
                    </button>

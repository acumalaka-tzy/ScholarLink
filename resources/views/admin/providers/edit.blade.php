...
<form action="{{ route('providers.update', ['provider' => $provider->id_provider]) }}" method="POST" class="bg-white rounded-[2rem] shadow-xl border border-gray-100 overflow-hidden">
    @csrf
    @method('PUT')

...
<div class="mb-10 flex items-center justify-between flex-wrap gap-4">
    <div>
        ...
        <h1 class="text-4xl font-black text-gray-900">Tambah Provider</h1>
        <p class="text-gray-500 font-bold mt-3 text-lg">Tambahkan provider baru ke platform ScholarLink.</p>
    </div>
</div>
...
<form action="{{ route('admin.providers.store') }}" method="POST" class="bg-white rounded-[2rem] shadow-xl border border-gray-100 overflow-hidden">
    ...
    <div class="p-8 md:p-10 border-b border-gray-100">
        <div class="flex items-center gap-4">
            ...
            <div>
                ...
                <p class="text-gray-500 font-bold mt-1">Lengkapi seluruh informasi provider dengan benar.</p>
            </div>
        </div>
    </div>
    ...
    <div class="p-8 md:p-10">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" name="nama_instansi" value="{{ old('nama_instansi') }}" placeholder="Masukkan nama instansi" class="w-full bg-gray-50 border-2 border-gray-200 rounded-2xl pl-14 pr-5 py-4 font-bold text-gray-900 placeholder:text-gray-400 focus:outline-none focus:border-cyan-500 focus:ring-4 focus:ring-cyan-100 transition">
                </div>
            </div>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="email" name="email_kontak" value="{{ old('email_kontak') }}" placeholder="contoh@email.com" class="w-full bg-gray-50 border-2 border-gray-200 rounded-2xl pl-14 pr-5 py-4 font-bold text-gray-900 placeholder:text-gray-400 focus:outline-none focus:border-cyan-500 focus:ring-4 focus:ring-cyan-100 transition">
                </div>
            </div>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" name="no_hp" value="{{ old('no_hp') }}" placeholder="Masukkan nomor HP" class="w-full bg-gray-50 border-2 border-gray-200 rounded-2xl pl-14 pr-5 py-4 font-bold text-gray-900 placeholder:text-gray-400 focus:outline-none focus:border-cyan-500 focus:ring-4 focus:ring-cyan-100 transition">
                </div>
            </div>
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="text" name="website" value="{{ old('website') }}" placeholder="https://website.com" class="w-full bg-gray-50 border-2 border-gray-200 rounded-2xl pl-14 pr-5 py-4 font-bold text-gray-900 placeholder:text-gray-400 focus:outline-none focus:border-cyan-500 focus:ring-4 focus:ring-cyan-100 transition">
                </div>
            </div>
        </div>
        ...
        <div class="mt-6">
            ...
            <textarea name="alamat" rows="4" placeholder="Masukkan alamat lengkap" class="w-full bg-gray-50 border-2 border-gray-200 rounded-2xl px-5 py-4 font-bold text-gray-900 placeholder:text-gray-400 focus:outline-none focus:border-cyan-500 focus:ring-4 focus:ring-cyan-100 transition resize-none">{{ old('alamat') }}</textarea>
        </div>
